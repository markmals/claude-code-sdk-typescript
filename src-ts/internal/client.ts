import type { Message, ClaudeCodeOptions, ContentBlock, TextBlock, ToolUseBlock, ToolResultBlock, AssistantMessage, SystemMessage, ResultMessage, UserMessage } from '../types'
...
export class InternalClient {
  ...
  private parseMessage(data: any): Message | null {
    switch (data.type) {
      case 'user':
        return { type: 'user', message: { content: data.message.content } } as UserMessage
      case 'assistant': {
